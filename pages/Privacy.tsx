    ...
    <div className="pt-20 pb-16 md:pt-24 md:pb-20 bg-slate-50 min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8 md:mb-12">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 mb-6 tracking-tight">Privacy Policy</h1>
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
          <div className="p-6 md:p-12 space-y-8 md:space-y-12 text-slate-600 leading-relaxed">
            ...
            {/* Section 1 */}
            <div className="group">
              <h2 className="flex items-center gap-3 text-xl md:text-2xl font-bold text-slate-900 mb-4 group-hover:text-primary transition-colors">
          ...
          <div className="bg-slate-900 p-7 md:p-10 border-t border-slate-800 text-center text-white">
